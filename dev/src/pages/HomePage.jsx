...
const HomePage = () => {
	...
	return (
		<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
			{/* 메인 배너 */}
			<div className='relative h-[400px] rounded-2xl overflow-hidden mb-12 bg-gradient-to-br from-[#00ED64] via-[#00684A] to-[#023430]'>
					...
					<div className='text-white p-8 max-w-2xl relative z-10'>
						<div className='space-y-4'>
							<h1 className='text-5xl font-bold mb-4 leading-tight'>
								당신의 독서 여정을
								<br />
								<span className='text-[#00ED64]'>공유</span>하세요
							</h1>
				...
				{/* 장식용 원형 요소들 */}
				<div className='absolute top-1/4 right-1/4 w-64 h-64 bg-[#00ED64]/20 rounded-full blur-3xl'></div>
				<div className='absolute bottom-1/4 left-1/4 w-48 h-48 bg-[#00684A]/20 rounded-full blur-2xl'></div>
			</div>
